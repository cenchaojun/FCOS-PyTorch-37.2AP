...
train_dataset = VOCDataset(root_dir='/home/cen/PycharmProjects/dataset/20201203dataset/fewdataset/voc2007',resize_size=[512,512],
...
for epoch in range(EPOCHS):
    ...
    torch.save(model.state_dict(),
               "./fewcheckpoint/model_{}.pth".format(epoch + 1))
record_pd.to_csv('./loss/fewloss/loss.csv',index=0)
