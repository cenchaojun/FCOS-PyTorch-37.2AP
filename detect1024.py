...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("./fewcheckpoint1024/model_60.pth", map_location=torch.device('cpu')))
    ...
    root = "/home/cen/PycharmProjects/dataset/20201203dataset/crop1024valdatasetimage/"
    ...
    for name in names:
        ...
        cv2.imwrite('./fewcrop1024val/{}'.format(name), img_pad)
        #
        # plt.figure()
