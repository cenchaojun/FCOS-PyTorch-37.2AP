#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2020/11/30 上午9:11
# @Author  : cenchaojun
# @File    : train_voc_p5.py
# @Software: PyCharm
...
train_dataset = VOCDataset(root_dir='/home/cen/PycharmProjects/dataset/20201029datasetvoc/voc2007',resize_size=[512,512],
...
for epoch in range(EPOCHS):
    ...
    torch.save(model.state_dict(),
               "./20201130checkout/model_{}.pth".format(epoch + 1))
record_pd.to_csv('./loss/crop5121130/loss.csv',index=0)
