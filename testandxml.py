...
if __name__ == "__main__":
    ...
    root = "/home/cen/PycharmProjects/dataset/20201029datasetvoc/voc2007/JPEGImages/"
    ...
    for name in names:
        ...
        # todo xml name
        xml_name = name[:-4] + '.xml'
        with open('/home/cen/PycharmProjects/dataset/testandxml/{0}'.format(xml_name),'w',encoding="utf-8") as f:
            f.write(xml)
