...
trained_path = '/home/cen/PycharmProjects/dataset/20201208dataset/fewtraindataset'
trained_file = glob.glob(trained_path + '/*.JPG')
image_file = set([image.split('/')[-1] for image in trained_file ])
total_path = '/home/cen/PycharmProjects/dataset/20201208dataset/traindataset'
...
extract_path = '/home/cen/PycharmProjects/dataset/20201208dataset/secondfewtraindataset'
